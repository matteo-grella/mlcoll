...
package MLColl.Neural_Networks.Recurrent.GRU_With_Attention is
    ...
    type Model_Type is record
        ...
        --- Attention layer
        Wa_In         : Real_Matrix_Access := null;
        Wa_Rec        : Real_Matrix_Access := null;
        Wb_In         : Real_Matrix_Access := null;
        Ba_In         : Real_Array_Access  := null;
        A_In          : Real_Array_Access  := null;
        ...
        --- Attention layer
        Wam_In         : Real_Matrix_Access := null;
        Wam_Rec        : Real_Matrix_Access := null;
        Bam_In         : Real_Array_Access  := null;
        Am_In          : Real_Array_Access  := null;
        Wbm_In         : Real_Matrix_Access := null;
        
        Wav_In         : Real_Matrix_Access := null;
        Wav_Rec        : Real_Matrix_Access := null;
        Bav_In         : Real_Array_Access  := null;
        Av_In          : Real_Array_Access  := null;
        Wbv_In         : Real_Matrix_Access := null;
    ...
    type GRU_Structure_Type
      (First_Sequence_Index        : Index_Type;
       ...
       Output_Layer_Last           : Index_Type) is record
        ...
        Sequence_Attention_Layers          : Real_Array_Access_Array (First_Sequence_Index .. Last_Sequence_Index) := (others => null);
        Sequence_Attention_Scores          : Real_Array_Access_Array (First_Sequence_Index .. Last_Sequence_Index) := (others => null);
        
        Sequence_Attention_Hidden_Layers_B : Real_Array_Access_Array (First_Sequence_Index .. Last_Sequence_Index) := (others => null);
        Sequence_Attention_Hidden_Layers_A : Attention_Layer_Array (First_Sequence_Index .. Last_Sequence_Index) := (others => null);
...
end MLColl.Neural_Networks.Recurrent.GRU_With_Attention;
