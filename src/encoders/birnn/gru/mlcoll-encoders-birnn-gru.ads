...
with MLColl.Neural_Networks.Recurrent.GRU;
--with MLColl.Neural_Networks.Recurrent.GRU_With_Attention;

private with Ada.Unchecked_Deallocation;

package MLColl.Encoders.BiRNN.GRU is

    package GRU renames MLColl.Neural_Networks.Recurrent.GRU;
    --package GRU renames MLColl.Neural_Networks.Recurrent.GRU_With_Attention;
