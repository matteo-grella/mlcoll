...
package body MLColl.Encoders.BiRNN.CFN is
    ...
    overriding procedure Initialize_BiRNN_Model
      (Model             : in out CFN_Model_Type;
       ...
       Verbose           : in Boolean := False) is
        ...
        CFN_Configuration : constant CFN.Configuration_Type
    ...
    begin
        ...
        for RNN_Direction in RNN_Direction_Type'Range loop
            CFN.Initialize
              (Model              => Model.RNN_Models (RNN_Direction),
               Configuration      => CFN_Configuration,
        ...
        if Verbose then
            ...
            Put_Line ("[L2R_RNN]  Input_Layer_Size: " & CFN.Get_Input_Layer_Size (Model.RNN_Models (L2R))'Img);
            Put_Line ("[L2R_RNN] Hidden_Layer_Size: " & CFN.Get_Hidden_Layer_Size (Model.RNN_Models (L2R))'Img);
            Put_Line ("[L2R_RNN] Output_Layer_Size: " & CFN.Get_Output_Layer_Size (Model.RNN_Models (L2R))'Img);
            New_Line;
            Put_Line ("[L2R_RNN]     Learning rate: " & Model.RNN_Models (R2L).Learning_Rate'Img);
            Put_Line ("[R2L_RNN]  Input_Layer_Size: " & CFN.Get_Input_Layer_Size (Model.RNN_Models (L2R))'Img);
            Put_Line ("[R2L_RNN] Hidden_Layer_Size: " & CFN.Get_Hidden_Layer_Size (Model.RNN_Models (L2R))'Img);
            Put_Line ("[R2L_RNN] Output_Layer_Size: " & CFN.Get_Output_Layer_Size (Model.RNN_Models (L2R))'Img);
            New_Line;
        end if;
    ...
    overriding procedure Finalize_BiRNN_Model
      (Model : in out CFN_Model_Type) is
    begin
    ...
    begin
        ...
        for RNN_Direction in RNN_Direction_Type'Range loop
            ...
            CFN.Initialize_CFN_Structure
              (CFN_Structure               => BiRNN_Structure.RNN_Structure (RNN_Direction).all);
        end loop;
    ...
    overriding procedure Finalize_BiRNN_Structure
      (BiRNN_Structure  : in out BiRNN_CFN_Structure_Type) is
    begin
    ...
    begin
        ...
        for RNN_Direction in RNN_Direction_Type'Range loop
            ...
            CFN.Forward
              (Model         => Model.RNN_Models (RNN_Direction),
               CFN_Structure => BiRNN_CFN_Structure_Type (BiRNN_Structure).RNN_Structure (RNN_Direction));
        end loop;
        ...
        Concatenate
          (V_Out  => BiRNN_Structure.Encoded_Sequence,
           V1_In  => BiRNN_CFN_Structure_Type (BiRNN_Structure).RNN_Structure (L2R).Sequence_Output,
           V2_In  => BiRNN_CFN_Structure_Type (BiRNN_Structure).RNN_Structure (R2L).Sequence_Output);
    ...
    begin
        ...
        Partition
          (V_In   => BiRNN_Structure.Sequence_Output_Error,
           V1_Out => BiRNN_CFN_Structure_Type (BiRNN_Structure).RNN_Structure (L2R).Sequence_Output_Error,
           V2_Out => BiRNN_CFN_Structure_Type (BiRNN_Structure).RNN_Structure (R2L).Sequence_Output_Error);
        ...
        for RNN_Direction in RNN_Direction_Type'Range loop
            ...
            CFN.Backward
              (Model          => Model.RNN_Models (RNN_Direction),
               CFN_Structure  => BiRNN_CFN_Structure_Type (BiRNN_Structure).RNN_Structure(RNN_Direction).all);
            ...
            CFN.Weight_Update
              (Model    => Model.RNN_Models (RNN_Direction),
               Gradient => BiRNN_CFN_Structure_Type (BiRNN_Structure).RNN_Structure (RNN_Direction).Gradient);
        ...
        Merge
          (V_Out => BiRNN_Structure.Input_Sequence_Gradients ,
           V1_In => BiRNN_CFN_Structure_Type (BiRNN_Structure).RNN_Structure(L2R).Sequence_Input_Gradients,
           V2_In => BiRNN_CFN_Structure_Type (BiRNN_Structure).RNN_Structure(R2L).Sequence_Input_Gradients);
