...
with MLColl.Neural_Networks.Recurrent.RNN;

private with Ada.Unchecked_Deallocation;

package MLColl.Encoders.BiRNN.RNN is

    package RNN renames MLColl.Neural_Networks.Recurrent.RNN;

    type RNN_Structure_Access_Type is access RNN.RNN_Structure_Type;

    type RNN_Model_Array     is array (RNN_Direction_Type) of RNN.Model_Type;
    type RNN_Structure_Array is array (RNN_Direction_Type) of RNN_Structure_Access_Type;

    type RNN_Model_Type is new Model_Type with
        record
            RNN_Models : RNN_Model_Array;
        end record;

    type BiRNN_RNN_Structure_Type is new BiRNN_Structure_Type with
        record
    ...
    overriding procedure Finalize_BiRNN_Structure
      (BiRNN_Structure  : in out BiRNN_RNN_Structure_Type) with
    ...
    overriding procedure Encode
      ...
      Pre => BiRNN_Structure.Initialized and BiRNN_Structure in BiRNN_RNN_Structure_Type;
...
private
    ...
    procedure Free is new
      Ada.Unchecked_Deallocation
        (RNN.RNN_Structure_Type, RNN_Structure_Access_Type);
