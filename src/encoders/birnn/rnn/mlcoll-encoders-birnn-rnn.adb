...
package body MLColl.Encoders.BiRNN.RNN is
    ...
    begin
        ...
        for RNN_Direction in RNN_Direction_Type'Range loop
            RNN.Initialize
              (Model              => Model.RNN_Models (RNN_Direction),
               Configuration      => RNN_Configuration,
        ...
        if Verbose then
            ...
            Put_Line ("[L2R_RNN]  Input_Layer_Size: " & RNN.Get_Input_Layer_Size (Model.RNN_Models (L2R))'Img);
            Put_Line ("[L2R_RNN] Hidden_Layer_Size: " & RNN.Get_Hidden_Layer_Size (Model.RNN_Models (L2R))'Img);
            Put_Line ("[L2R_RNN] Output_Layer_Size: " & RNN.Get_Output_Layer_Size (Model.RNN_Models (L2R))'Img);
            New_Line;
            Put_Line ("[L2R_RNN]     Learning rate: " & Model.RNN_Models (R2L).Learning_Rate'Img);
            Put_Line ("[R2L_RNN]  Input_Layer_Size: " & RNN.Get_Input_Layer_Size (Model.RNN_Models (L2R))'Img);
            Put_Line ("[R2L_RNN] Hidden_Layer_Size: " & RNN.Get_Hidden_Layer_Size (Model.RNN_Models (L2R))'Img);
            Put_Line ("[R2L_RNN] Output_Layer_Size: " & RNN.Get_Output_Layer_Size (Model.RNN_Models (L2R))'Img);
            New_Line;
        end if;
    ...
    overriding procedure Finalize_BiRNN_Model
      (Model : in out RNN_Model_Type) is
    begin
    ...
    overriding procedure Initialize_BiRNN_Structure
      (BiRNN_Structure   : in out BiRNN_RNN_Structure_Type;
       Input_Layer_Size  : in Positive;
       Hidden_Layer_Size : in Positive;
       Output_Layer_Size : in Positive;
    ...
    begin
        ...
        for RNN_Direction in RNN_Direction_Type'Range loop
            ...
            RNN.Initialize_RNN_Structure
              (RNN_Structure => BiRNN_Structure.RNN_Structure (RNN_Direction).all);
        end loop;
    ...
    overriding procedure Finalize_BiRNN_Structure
      (BiRNN_Structure  : in out BiRNN_RNN_Structure_Type) is
    begin
    ...
    begin
        ...
        for RNN_Direction in RNN_Direction_Type'Range loop
            ...
            RNN.Forward
              (Model         => Model.RNN_Models (RNN_Direction),
               RNN_Structure => BiRNN_RNN_Structure_Type (BiRNN_Structure).RNN_Structure (RNN_Direction));
        end loop;
        ...
        Concatenate
          (V_Out  => BiRNN_Structure.Encoded_Sequence,
           V1_In  => BiRNN_RNN_Structure_Type (BiRNN_Structure).RNN_Structure (L2R).Sequence_Output,
           V2_In  => BiRNN_RNN_Structure_Type (BiRNN_Structure).RNN_Structure (R2L).Sequence_Output);
    ...
    begin
        ...
        Partition
          (V_In   => BiRNN_Structure.Sequence_Output_Error,
           V1_Out => BiRNN_RNN_Structure_Type (BiRNN_Structure).RNN_Structure (L2R).Sequence_Output_Error,
           V2_Out => BiRNN_RNN_Structure_Type (BiRNN_Structure).RNN_Structure (R2L).Sequence_Output_Error);
        ...
        for RNN_Direction in RNN_Direction_Type'Range loop
            ...
            RNN.Weight_Update
              (Model    => Model.RNN_Models (RNN_Direction),
               Gradient => BiRNN_RNN_Structure_Type (BiRNN_Structure).RNN_Structure (RNN_Direction).Gradient);
        ...
        Merge
          (V_Out => BiRNN_Structure.Input_Sequence_Gradients ,
           V1_In => BiRNN_RNN_Structure_Type (BiRNN_Structure).RNN_Structure (L2R).Sequence_Input_Gradients,
           V2_In => BiRNN_RNN_Structure_Type (BiRNN_Structure).RNN_Structure (R2L).Sequence_Input_Gradients);

    end Learn;

end MLColl.Encoders.BiRNN.RNN;
