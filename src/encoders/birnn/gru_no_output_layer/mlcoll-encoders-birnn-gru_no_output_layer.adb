...
package body MLColl.Encoders.BiRNN.GRU_No_Output_Layer is
    ...
    begin
        ...
        Model.Output_Layer_Size := Output_Layer_Size; -- don't delete this
    ...
    begin
        ...
        Concatenate
          (V_Out  => BiRNN_Structure.Encoded_Sequence,
           V1_In  => BiRNN_GRU_Structure_Type (BiRNN_Structure).RNN_Structure (L2R).Sequence_Hidden,
           V2_In  => BiRNN_GRU_Structure_Type (BiRNN_Structure).RNN_Structure (R2L).Sequence_Hidden);
    ...
    begin
        ...
        Partition
          (V_In   => BiRNN_Structure.Sequence_Output_Error,
           V1_Out => BiRNN_GRU_Structure_Type (BiRNN_Structure).RNN_Structure (L2R).Sequence_Hidden_Error,
           V2_Out => BiRNN_GRU_Structure_Type (BiRNN_Structure).RNN_Structure (R2L).Sequence_Hidden_Error);
